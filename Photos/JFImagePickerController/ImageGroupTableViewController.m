//
//  ImageGroupTableViewController.m
...
@interface ImageGroupTableViewController ()

@end

@implementation ImageGroupTableViewController
...
- (void)viewDidLoad
{
	...
	[ASSETHELPER getGroupList:^(NSArray *a) {
		...
		ImageCollectionViewController *picker = [[ImageCollectionViewController alloc] initWithNibName:nil bundle:nil];
